...
> [Veja como ficou](https://msgaspar.github.io/trybe-projects/todo-list)
...
O objetivo neste projeto foi desenvolver uma página web que permite a criação de uma lista de tarefas, usando HTML, CSS e JavaScript.
