...
Projeto realizado no curso de Desenvolvimento Web da Trybe como parte do **Bloco 04 - Introdução a JavaScript e Lógica de Programação**, dentro do Módulo 1 - Fundamentos do Desenvolvimento Web.

## Habilidades Praticadas

  - Uso de variáveis e tipos primitivos em JavaScript
  - Uso de conceitos como tipagem dinâmica e operadores lógicos/aritméticos/de atribuição
  - Estruturas condicionais
  - Uso e manipulação de arrays (listas)
  - Estruturas de repetição
  - Quebra de problemas grandes em partes menores
  - Manipulação de objetos
  - Uso de funções para organizar e estruturar melhor o código

## Sobre o Projeto

Neste projeto, o objetivo foi trabalhar na implementação de uma série de funções em JavaScript, conforme os requisitos apresentados. O atendimento aos requisitos foi verificado por meio de avaliador automático e o código deveria atender às exigências do linter, com regras estabelecidas pela Trybe.
