...
> [Veja como ficou](https://msgaspar.github.io/trybe-projects/pixels-art/)
...
Neste projeto, o objetivo foi implementar uma página web que contém uma paleta de cores (geradas aleatoriamente), que pode ser usada para criar desenhos em um "quadro de pixels". O atendimento aos requisitos foi verificado por meio de avaliador automático e o código deveria atender às exigências do linter, com regras estabelecidas pela Trybe.
