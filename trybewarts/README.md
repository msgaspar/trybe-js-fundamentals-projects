...
- Criação de regras CSS específicas para serem aplicadas a dispositívos móveis
- **Fluxo de trabalho em equipe utilizando Git e Github**

## Sobre o projeto

Neste projeto recebemos a missão de desenvolver uma página de formulário da Escola de Magia de Trybewarts, com o qual as pessoas estudantes poderão enviar seus feedback sobre a escola, atendendo aos requisitos estabelecidos.
