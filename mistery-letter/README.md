...
> [Veja como ficou](https://msgaspar.github.io/trybe-projects/mistery-letter)

## Habilidades Trabalhadas

  - Manipulação dos elementos do DOM usando JavaScript
  - Manipulação de estilos com CSS e JavaScript

## Sobre o Projeto

Neste projeto, o objetivo foi desenvolver uma página web na qual o usuário pode digitar o texto de uma carta, e a página gera uma "carta misteriosa", com cada uma das palavras formatada de forma diferente e aleatória, como se fossem palavras recortadas de revistas e jornais.
