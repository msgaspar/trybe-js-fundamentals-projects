...
Projeto realizado no curso de Desenvolvimento Web da Trybe como parte do **Bloco 08 - Higher Order Functions do JavaScript ES6**, dentro do Módulo 1 - Fundamentos do Desenvolvimento Web.

## Habilidades Trabalhadas

- Produção de código legível, conciso e expressivo utilizando as funcionalidades do ES6
- Uso das Higher Order Functions para manipular e criar arrays
- Escolha da Higher Order Function mais adequada para a obtenção de um resultado esperado
- Uso de diferentes Higher Order Functions em conjunto
- Interpretação de testes unitários para produzir soluções que atendam a eles

## Sobre o Projeto

O objetivo neste projeto foi implementar diversas funções para atender aos requisitos propostos, garantindo que todas passem nos testes unitários fornecidos.
