...
Projeto realizado no curso de Desenvolvimento Web da Trybe como parte do **Bloco 07 - Introdução ao JavaScript ES6 e testes unitários**, dentro do Módulo 1 - Fundamentos do Desenvolvimento Web.

## Habilidades Trabalhadas

- Escrita de testes unitários para funções utilizando o módulo Assert do NodeJS
- Implementação de funções em JavaScript de forma que elas atendas a testes unitários já propostos
- Implementação de testes e funções utilizando uma abordagem de desenvolvimento orientado a testes (TDD)

## Sobre o Projeto

Neste projeto o objetivo foi implementar funções de acordo com os requisitos propostos, em alguns casos com testes unitários já prontos e em outros tendo que implementar também os testes. Também foi praticada a implementação de funções com seus testes utilizando o fluxo de trabalho do TDD - Test Driven Development.
