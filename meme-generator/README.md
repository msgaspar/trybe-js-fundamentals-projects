...
O projeto visou desenvolver uma página web na qual o usuário pode abrir um arquivo de imagem local e digitar um texto de entrada para produzir um "meme". 
